...
export const ONBOARDING_QUESTIONS: EQQuestion[] = [
  // ---- Self-awareness ----
  {
    ...
    question:
      "Хүчтэй сэтгэл хөдлөл төрөхөд ихэвчлэн ямар мэдрэмж төрж байгааг мэддэг үү?",
    options: opts(
      "Юу болж байгааг анзаардаггүй.",
  ...
  },
  {
    ...
    type: "onboarding",
    eqArea: "SELF_AWARENESS",
    question: "Өдрийн эцэст сэтгэлийн санааны байдлаа эргэцүүлж боддог уу?",
    options: opts(
  ...
  },
  {
    ...
    options: opts(
      ...
      "Бие маань хэрхэн хариу үзүүлж байгааг ажиглаад шуурхай мэдэрдэг.",
    ),
  },
  {
    ...
    options: opts(
      ...
      "Хааяа таамагладаг.",
      "Ихэнхдээ шалтгааныг олж хардаг.",
  ...
  // ---- Self-regulation ----
  {
    ...
    question: "Уурлах эсвэл бухимдах үедээ чи юу хийдэг вэ?",
    options: opts(
  ...
  },
  {
    ...
    options: opts(
      ...
      "Бичих эсэхээ бага зэрэг боддог.",
  ...
  },
  {
    ...
    type: "onboarding",
    eqArea: "SELF_REGULATION",
    question: "Сэтгэл хөдлөл хэт ихэсхэд?",
    options: opts(
      "Бүрэн автаж, юу ч хийж чадахгүй болдог.",
      "Дарж байхыг хичээдэг ч хэцүү байдаг.",
      "Гарах гарц хайх гэж оролддог.",
  ...
  },
  {
    ...
    type: "onboarding",
    eqArea: "SELF_REGULATION",
    question: "Төлөвлөгөө чинь гэнэт өөрчлөгдөхөд хэрхэн хариу үзүүлдэг вэ?",
    options: opts(
      "Их бухимддаг, удаан сэргэдэг.",
      "Ихэндээ бухимддаг ч аажмаар дасдаг.",
      "Тийм ч их санаа зовдоггүй.",
      "Уян хатан, шинэ нөхцөлд хурдан зохицдог.",
    ),
  },
  ...
  // ---- Motivation ----
  {
    ...
    type: "onboarding",
    eqArea: "MOTIVATION",
    question: "Хийх ёстой зүйлээ хийх хүсэлгүй болвол?",
    options: opts(
      "Орхиод явчихдаг.",
  ...
  },
  {
    ...
    options: opts(
      "Зорилгынхаа тухай бодож үзээгүй.",
      "Ихэвчлэн бусдын хүлээлтээр зорилго тавьдаг.",
      "Заримдаа өөрийн юу үнэхээр хүссэж байгаагаа боддог.",
      "Юу үнэхээр чухал болохоо мэддэг, түүнийгээ дагадаг.",
    ),
  },
  {
  ...
  },
  {
    ...
    type: "onboarding",
    eqArea: "MOTIVATION",
    question: "Ирээдүйнхээ талаар боддог уу?",
    options: opts(
      "Нээх их хамаагүй юм шиг санагддаг.",
      "Тодорхойгүй, бараг боддогүй.",
      "Заримдаа боддог.",
      "Хэн болохыг хүсэж байгаагаа мэдэж байгаа.",
    ),
  },
  ...
  },
  {
    ...
    options: opts(
      "Зөвхөн өөрийнхөө зөвтгөж боддог.",
      "Уурласан хэвээр удаан хугацаанд явдаг.",
      "Түүний оронд өөрийгөө тавьж бодохыг оролддог.",
  ...
  // ---- Social skills ----
  {
    ...
    options: opts(
      ...
      "Дэлбэртлээ уурлау, шууд хэлчихдэг.",
      "Хэлэхийг оролддог ч эвгүй байдаг.",
      "Тайван, тодорхой, гэхдээ зөөлөнөөр илэрхийлдэг.",
    ),
  },
  {
  ...
  },
  {
    ...
    options: opts(
      "Гуйж чаддаггүй.",
      "Доошоо орох гэж байгаа юм шиг мэдрэмж төрдөг ч албадлагаар гуйдаг.",
      "Гуйдаг ч эвгүйрхдэг.",
...
const WEEKLY_SET_1: EQQuestion[] = [
  // ---- Self-awareness ----
  {
    ...
    type: "weekly",
    eqArea: "SELF_AWARENESS",
    question: "Энэ долоо хоногт мэдрэмжээ хэр сайн таньж чадав?",
    options: opts(
  ...
  },
  {
    ...
    type: "weekly",
    eqArea: "SELF_AWARENESS",
    question: "Энэ долоо хоногт сэтгэл санаагаа эргэцүүлэх цаг гаргасан уу?",
    options: opts(
      "Огт үгүй.",
      "Маш бага.",
      "Хэдэн удаа.",
  ...
  // ---- Self-regulation ----
  {
    ...
    eqArea: "SELF_REGULATION",
    question:
      "Энэ долоо хоногт сэтгэл хөдлөлөө удирдахын тулд ихэвчлэн юу хийв?",
    options: opts(
  ...
  },
  {
    ...
    options: opts(
      "Чадаагүй, шууд хариу үйлдэл хийсэн.",
      "Заримдаа л чадсан.",
      "Ихэнхдээ түр зогсож чадсан.",
      "Тайвширсныхаа дараа шийдсэн.",
    ),
  },
  ...
  // ---- Motivation ----
  {
    ...
    type: "weekly",
    eqArea: "MOTIVATION",
    question: "Энэ долоо хоногт юу чухал болохоо хэр олсон бэ?",
    options: opts(
      "Олоогүй ээ kkk.",
      "Тодорхойгүй байсан.",
      "Заримдаа тодорхойлж чадсан.",
  ...
  },
  {
    ...
    type: "weekly",
    eqArea: "MOTIVATION",
    question: "Жижиг ч байсан урагшлах алхам хийв үү?",
    options: opts(
      "Огт үгүй.",
  ...
  // ---- Empathy ----
  {
    ...
    eqArea: "EMPATHY",
    question:
      "Энэ долоо хоногт хэн нэгний өнцөгөөс асуудалыг харах гэж хэр оролдов?",
    options: opts(
  ...
  },
  {
    ...
    type: "weekly",
    eqArea: "EMPATHY",
    question: "Хэн нэгний үйлдлийг муугаар бодсон уу?",
    options: opts(
      "Байнга тэгсэн.",
      "Ихэвчлэн тэгсэн.",
      "Хааяа, гэхдээ өөр тайлбар ч хайсан.",
      "Нээлттэйгээр, “магадгүй” гэсэн байр сууринаас бодсон.",
    ),
  },
  ...
  // ---- Social skills ----
  {
    ...
    type: "weekly",
    eqArea: "SOCIAL_SKILLS",
    question: "Энэ долоо хоногт мэдрэмжээ хэр илэрхийлэв?",
    options: opts(
      "Дотроо хадгалсан.",
      "Хэлэх гэж оролдсон ч эвгүй байсан.",
  ...
  },
  {
    ...
    type: "weekly",
    eqArea: "SOCIAL_SKILLS",
    question: "Үл ойлголцсон үедээ харилцаагаа засах гэж оролдов уу?",
    options: opts(
      "Зайлсхийсэн.",
      "Маргалдсан.",
...
const WEEKLY_SET_2: EQQuestion[] = [
  {
    ...
    eqArea: "SELF_AWARENESS",
    question:
      "Энэ долоо хоногт хүчтэй мэдрэмж чинь биеийн чинь аль хэсэгт мэдрэгдсэнийг анзаарсан уу?",
    options: opts(
      "Огт анзаараагүй.",
      "Дараа нь л ойлгосон.",
  ...
  },
  {
    ...
    type: "weekly",
    eqArea: "SELF_AWARENESS",
    question: "Сэтгэл санааны өөрчлөлтийнхөө шалтгааныг ойлгож чадав уу?",
    options: opts(
  ...
  },
  {
    ...
    type: "weekly",
    eqArea: "SOCIAL_SKILLS",
    question: "Өөрийнхөө юу мэдэрч байгааг хэн нэгэнд илэрхийлж чадав уу?",
    options: opts(
      "Хэлж чадаагүй.",
      "Хэлэх гэж оролдсон ч эвгүй байсан.",
...
const WEEKLY_SET_3: EQQuestion[] = [
  ...
  },
  {
    ...
    type: "weekly",
    eqArea: "SELF_REGULATION",
    question: "Гэнэтийн зүйл тохиолдоход хэрхэн хариу үзүүлэв?",
    options: opts(
      "Их бухимдсан.",
  ...
  },
  {
    ...
    options: opts("Үгүй.", "Бараг үгүй.", "Хааяа.", "Анхааралтай сонссон."),
  },
  {
